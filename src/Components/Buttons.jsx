...
function Buttons({ b, setInput, input, sign, setSign, count, setCount, decimal, setDecimal, digits }) {
  ...
  return (
    <Box w='100%' h='20' alignItems='center' justifyContent='center' color='teal.500'  display='flex' borderWidth={1}
         ...
         onClick={() => buttonClick(b,setInput, input, sign, setSign, count, setCount, decimal, setDecimal, digits)}>
      {b}
    </Box>
  );
}
